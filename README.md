...
scripts/
  ...
  publish_public.js          # Publish to GitHub + ClawHub + npm
...
# 3. Publish (GitHub Release + ClawHub + npm)
PUBLIC_REPO="EvoMap/evolver" node scripts/publish_public.js
cd dist-public && npm publish --access public
```

All three channels (GitHub Release, npm, ClawHub) must succeed.

| Channel | Target |
|---------|--------|
| GitHub Release | `EvoMap/evolver` |
| npm | `@evomap/evolver` |
| ClawHub | `evolver` + `capability-evolver` |
...
| Private Repo | Public Repo | ClawHub Slug |
|---|---|---|
| [EvoMap/feishu-evolver-wrapper-private](https://github.com/EvoMap/feishu-evolver-wrapper-private) | `EvoMap/feishu-evolver-wrapper` | `feishu-evolver-wrapper` |
| Local path: `/home/kprimo97/evomap/feishu-evolver-wrapper-private` | | |
